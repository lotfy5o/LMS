                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img id="showImage"
                                                src="{{ $profileData->getFirstMediaUrl('admins') ?: asset('upload/no-image.jpg') }}"
                                    ...
                                    <form action="{{ route('admin.profile.store') }}" method="post"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <img id="showImage"
                                                        src="{{ !empty($profileData->photo) ? url('upload/admin-images/' . $profileData->photo) : url('upload/no-image.jpg') }}"
                                                        alt="Admin"
