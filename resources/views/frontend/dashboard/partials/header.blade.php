                                                    ...
                                                    <li>
                                                        <div class="media media-card">
                                                            <a href="course-details.html" class="media-img">
                                                                <img class="mr-3"
                                                                    src="{{asset('asset-front')}}/images/small-img.jpg"
                                                                    alt="Cart image">
                                                            </a>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid" src="{{ (!empty($profileData->photo)) ?
                url('upload/user-images/' . $profileData->photo) : url('upload/no-image.jpg') }}" alt="Avatar image">
                                                    </div>
                                                    <span class="dot-status bg-1"></span>
                                                </div>
                                                <ul
