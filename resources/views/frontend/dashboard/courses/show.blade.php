...
<html lang="en">
    ...
    @include('frontend.dashboard.courses.show-partials.head')
                    ...
                    <div class="main-menu-content d-flex align-items-center">
                        <div class="logo-box logo--box">
                            <div class="theme-picker d-flex align-items-center">
                                <button class="theme-picker-btn dark-mode-btn" title="Dark mode">
                                    <svg class="svg-icon-color-white" viewBox="0 0 24 24"
                        ...
                        <div class="course-dashboard-header-title pl-4">
                            <a href="course-details.html"
                                class="text-white fs-15">{{ $course->name }}</a>
                        ...
                        <div class="menu-wrapper ml-auto">
                            ...
                            <div class="nav-right-button d-flex align-items-center">
                                <a href="#"
                                    ...
                                    data-toggle="modal" data-target="#ratingModal"><i
                                        class="la la-star mr-1"></i> leave a rating</a>
                                <a href="#"
                                    class="btn theme-btn theme-btn-sm theme-btn-transparent lh-26 text-white mr-2"
                                ...
                                <div class="generic-action-wrap generic--action-wrap">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item" href="#">Favorite this
                                                course</a>
                                            <a class="dropdown-item" href="#">Archive this
                                                course</a>
                                            <a class="dropdown-item" href="#">Gift this
                                                course</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="course-dashboard-container d-flex">
                    <div class="course-dashboard-column">
                                    ...
                                    <div class="lecture-viewer-text-body">
                                        ...
                                        <div class="lecture-viewer-content-detail">
                                            <ul class="generic-list-item pb-4">
                                                <li>Hi</li>
                                                <li>Welcome to Motion Graphics in After Effects.
                                                </li>
                                                <li>In the next lectures you will start creating
                                                    your first animation and animate imported
                                                    footage.</li>
                                                ...
                                                <li>At vero eos et accusamus et iusto odio
                                                    ...
                                                    est laborum et dolorum fuga. </li>
                                                <li>Occaecati cupiditate non provident, similique
                                                ...
                                                <li>On the other hand, we denounce with righteous
                                                    ...
                                                    easy to distinguish. </li>
                                                <li><strong class="font-weight-semi-bold">Download
                                                        your footage Now, Click on the Link
                                                        Below.</strong></li>
                                            </ul>
                                            <div class="btn-box">
                                                <h3 class="fs-18 font-weight-semi-bold pb-3">
                                                    Resources for this lecture</h3>
                                                <a href="#"
                        ...
                        <div class="lecture-video-detail">
                            <div class="lecture-tab-body bg-gray p-4">
                                <ul class="nav nav-tabs generic-tab" id="myTab"
                                    role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" id="search-tab" data-toggle="tab"
                                            href="#search" role="tab" aria-controls="search"
                                            aria-selected="false">
                                            <i class="la la-search"></i>
                                        </a>
                                    </li>
                                    <li class="nav-item mobile-menu-nav-item">
                                        <a class="nav-link" id="course-content-tab"
                                            data-toggle="tab" href="#course-content"
                                            role="tab" aria-controls="course-content"
                                            aria-selected="false">
                                            Course Content
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="question-and-ans-tab"
                                            data-toggle="tab" href="#question-and-ans"
                                            role="tab" aria-controls="question-and-ans"
                                            aria-selected="false">
                                            Question & Ans
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="announcements-tab"
                                            data-toggle="tab" href="#announcements"
                                            role="tab" aria-controls="announcements"
                                            aria-selected="false">
                                            Announcements
                                        </a>
                                    </li>
                            ...
                            <div class="lecture-video-detail-body">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade" id="search" role="tabpanel"
                                        ...
                                        <div class="search-course-wrap pt-40px">
                                            ...
                                            <div class="search-results-message text-center">
                                                <h3 class="fs-24 font-weight-semi-bold pb-1">Start
                                                    a new search</h3>
                                        ...
                                        <div class="mobile-course-menu pt-4">
                                            <div class="accordion generic-accordion generic--accordion"
                                                ...
                                                <div class="card">
                                                    <div class="card-header"
                                                        ...
                                                        <button class="btn btn-link"
                                                            ...
                                                            <span class="fs-15"> Section 1: Dive
                                                                in and Discover After Effects</span>
                                                    ...
                                                    <div id="mobileCourseCollapseOne"
                                                        class="collapse show"
                                                        ...
                                                        <div class="card-body p-0">
                                                            <ul class="curriculum-sidebar-list">
                                                                ...
                                                                <li
                                                                    class="course-item-link active-resource">
                                                                    <div
                                                                        class="course-item-content-wrap">
                                                                        <div
                                                                            class="custom-control custom-checkbox">
                                                ...
                                                <div class="card">
                                                    <div class="card-header"
                                                        ...
                                                        <button class="btn btn-link collapsed"
                                                            ...
                                                            <i class="la la-angle-down"></i>
                                                            <i class="la la-angle-up"></i>
                                                            <span class="fs-15">Section 2: Jump
                                                                Start Into Motion Graphics</span>
                                                            <span class="course-duration">
                                                                <span>1/5</span>
                                                                <span>21min</span>
                                                            </span>
                                                    ...
                                                    <div id="mobileCourseCollapseTwo"
                                                        class="collapse"
                                                ...
                                                <div class="card">
                                                    <div class="card-header"
                                                        ...
                                                        <button class="btn btn-link collapsed"
                                                            ...
                                                            <i class="la la-angle-down"></i>
                                                            <i class="la la-angle-up"></i>
                                                            <span class="fs-15">Section 3:
                                                                Graphics from within After
                                                                Effects</span>
                                                            <span class="course-duration">
                                                                <span>1/5</span>
                                                                <span>21min</span>
                                                    ...
                                                    <div id="mobileCourseCollapseThree"
                                                        class="collapse"
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="mobileCourseCollapseFour"
                                                        class="collapse"
                                    ...
                                    <div class="tab-pane fade show active" id="overview"
                                        ...
                                        <div class="lecture-overview-wrap">
                                            <div class="lecture-overview-item">
                                                <h3 class="fs-24 font-weight-semi-bold pb-2">About
                                                    this course</h3>
                                                <p>Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit. Deleniti dicta eos iste maxime
                                                    sapiente similique totam? Consequatur
                                                    consequuntur excepturi in, magni necessitatibus
                                                    nemo quae repellendus</p>
                                            ...
                                            <div class="lecture-overview-item">
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    <div class="lecture-overview-stats-item">
                                                        <h3
                                                            class="fs-16 font-weight-semi-bold pb-2">
                                                            By the numbers</h3>
                                                    </div><!-- end lecture-overview-stats-item -->
                                                    <div class="lecture-overview-stats-item">
                                                        <ul class="generic-list-item">
                                                            <li><span>Skill level:</span>All Levels
                                                            </li>
                                                    ...
                                                    <div class="lecture-overview-stats-item">
                                                        <ul class="generic-list-item">
                                                            ...
                                                            <li><span>Video length:</span>3.5 total
                                                                hours</li>
                                            ...
                                            <div class="lecture-overview-item">
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="pb-3">Get Aduca certificate by
                                                            completing entire course</p>
                                                        <a href="#"
                                                ...
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <div class="lecture-overview-stats-item">
                                                        <p>Available on <a href="#"
                                                                class="text-color hover-underline">IOS</a>
                                                            and <a href="#"
                                                ...
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <h3
                                                            ...
                                                            After Effects CC 2020 Complete Course
                                                        </h3>
                                                        <p>Lorem ipsum dolor sit amet, consectetur
                                                            adipisicing elit. Cumque ea esse
                                                            inventore odit voluptate. Accusantium
                                                            asperiores at doloremque ex impedit ipsa
                                                            itaque. Consequuntur dignissimos itaque
                                                            mollitia tenetur voluptatem. Aut beatae
                                                            blanditiis consequuntur corporis
                                                            delectus deserunt dolores eos et fugit
                                                            hic illo, impedit in magnam mollitia
                                                            nulla placeat porro, possimus quae
                                                            quaerat quasi quidem recusandae
                                                            reprehenderit saepe, suscipit
                                                            voluptatibus.</p>
                                                        <div class="collapse" id="collapseMore">
                                                            <p>Aliquid odit perspiciatis quidem
                                                                rerum? Architecto aspernatur beatae
                                                                consectetur illo labore molestias
                                                                natus, provident quas tempore ut
                                                                vitae voluptate! Dicta doloremque
                                                                dolores doloribus dolorum ea enim
                                                                est ex harum mollitia natus
                                                                necessitatibus, non officiis
                                                                repellat rerum sed sint vel
                                                                voluptatem. Aspernatur enim error
                                                                esse facere numquam quidem
                                                                reiciendis sit soluta suscipit
                                                                voluptates.</p>
                                                            <ul
                                                                ...
                                                                <li>Cumque ea esse inventore odit
                                                                    voluptate.</li>
                                                                <li>Phasellus posuere urna et
                                                                    faucibus</li>
                                                                <li>Mauris faucibus ligula
                                                                    vestibulum </li>
                                                                <li>Phasellus posuere urna </li>
                                                            </ul>
                                                            <p>impedit in magnam mollitia nulla
                                                                placeat porro, possimus quae quaerat
                                                                quasi quidem recusandae
                                                                reprehenderit saepe, suscipit
                                                                voluptatibus. Beatae, fugiat? Lorem
                                                                ipsum dolor sit amet, consectetur
                                                                adipisicing elit. Cumque ea esse
                                                                inventore odit voluptate.
                                                                Accusantium asperiores at doloremque
                                                                ex impedit ipsa itaque. Consequuntur
                                                                dignissimos itaque mollitia tenetur
                                                                voluptatem. Aut beatae blanditiis
                                                                consequuntur corporis delectus
                                                                deserunt dolores eos et fugit hic
                                                                illo, impedit in magnam mollitia
                                                                nulla placeat porro, possimus quae
                                                                quaerat quasi quidem recusandae
                                                                reprehenderit saepe, suscipit
                                                        ...
                                                        <div class="show-more-btn-box">
                                                            <a class="collapse-btn collapse--btn fs-15"
                                                                ...
                                                                <span
                                                                    class="collapse-btn-hide">Read
                                                                    more<i
                                                                        class="la la-angle-down ml-1 fs-14"></i></span>
                                                                <span
                                                                    class="collapse-btn-show">Read
                                                                    less<i
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="teacher-detail.html"
                                                                ...
                                                                <img src="{{ asset('asset-front') }}/images/small-avatar-1.jpg"
                                                            ...
                                                            <div class="media-body">
                                                                <h5><a href="teacher-detail.html">Alex
                                                                        Smith</a></h5>
                                                                <span
                                                                    class="d-block lh-18 pt-2">Java
                                                                    Python Android and C# Expert
                                                                    Developer</span>
                                                            </div>
                                                        </div>
                                                        <div class="lecture-owner-profile pt-4">
                                                            <ul
                                                                class="social-icons social-icons-styled">
                                                                <li><a href="#"
                                                                        class="facebook-bg"><i
                                                        ...
                                                        <div class="lecture-owner-decription pt-4">
                                                            <p>Lorem ipsum dolor sit amet,
                                                                ...
                                                                faucibus ligula vestibulum venenatis
                                                                efficitur. Phasellus posuere urna et
                                                                faucibus vestibulum. Duis quis eros.
                                                            ...
                                                            <p>Consequuntur dignissimos itaque
                                                                mollitia tenetur voluptatem. Aut
                                                                beatae blanditiis consequuntur
                                                                corporis delectus deserunt dolores
                                                                eos et fugit hic illo, impedit in
                                                                magnam mollitia nulla placeat porro,
                                                                possimus quae quaerat quasi quidem
                                                                recusandae reprehenderit saepe,
                                                                suscipit voluptatibus.</p>
                                                            <p><strong>After Effects:</strong> The
                                                                whole lot. In my course After
                                                                Effects Complete Course packed with
                                                                all Techniques and Methods (No
                                                                Tricks and gimmicks).</p>
                                                            <p><strong>Video Editing:</strong> If
                                                                it's Adobe Premiere Pro or DaVinci
                                                                Resolve you have excellent top rated
                                                                courses.</p>
                                                            <p>I guess 208,000+ Students is a good
                                                                sign that my courses will be of
                                                                benefit to you.</p>
                                                            <p>Cheers</p>
                                                            <p>Alex</p>
                                                        </div>
                                                ...
                                                <div class="new-question-body pt-40px">
                                                    ...
                                                    <form method="post"
                                                        ...
                                                        <div class="btn-box text-center">
                                                            <button
                                                                class="btn theme-btn w-100">Continue
                                                                <i
                                    ...
                                    <div class="tab-pane fade" id="announcements" role="tabpanel"
                                        ...
                                        <div
                                            class="lecture-overview-wrap lecture-announcement-wrap">
                                            <div class="lecture-overview-item">
                                                ...
                                                <div class="lecture-owner-decription pt-4">
                                                    <h3 class="fs-19 font-weight-semi-bold pb-3">
                                                        Important Q&A support</h3>
                                                    <p>Happy 2019 to everyone, thank you for being a
                                                        student and all of your support.</p>
                                                    <p><strong>Great job on enrolling and your
                                                            current course progress. I encourage you
                                                            keep in pursuit of your dreams
                                                            :)</strong></p>
                                                    <p>The whole lot. In my course After Effects
                                                        Complete Course packed with all Techniques
                                                        and Methods (No Tricks and gimmicks).</p>
                                                    <p class="font-italic"><strong>Unfortunately
                                                            this will result in delayed responses by
                                                            me in the Q&A section and to direct
                                                            messages. This is only for the next week
                                                            and once back I will be back to 100%
                                                            .</strong></p>
                                                    <p>I will continue to do my best to respond to
                                                        ...
                                                        can image that its a lot of work.</p>
                                                    <p class="font-italic">Thank you once again for
                                                        your understanding and for all of the
                                                        wonderful students who I have had an
                                                        opportunity to communicate with regularly
                                                        and all of your encouragement.</p>
                                                    <p>Have an awesome day</p>
                                                    <p>Alex</p>
                                                </div>
                                                <div
                                                    class="lecture-announcement-comment-wrap pt-4">
                                                    <div
                                                        class="media media-card align-items-center">
                                                        <div
                                                            class="media-img rounded-full avatar-sm flex-shrink-0">
                    ...
                    <div class="course-dashboard-sidebar-column">
                        <button class="sidebar-open" type="button"><i
                                class="la la-angle-left"></i> Course content</button>
                        <div class="course-dashboard-sidebar-wrap custom-scrollbar-styled">
                            <div
                                ...
                                <button class="sidebar-close" type="button"><i
                                        ...
                                        <div class="card">
                                            <div class="card-header"
                                                ...
                                                <button class="btn btn-link" type="button"
                                                    ...
                                                    <i class="la la-angle-down"></i>
                                                    <i class="la la-angle-up"></i>
                                                    <span class="fs-15"> Section
                                                        {{ $key++ + 1 }}:
                                                        {{ $section->name }}</span>
                                                    <span class="course-duration">
                                                        <span>1/{{ count($section->lectures) }}</span>
                                            ...
                                            <div id="collapseOne{{ $section->id }}"
                                                ...
                                                <div class="card-body p-0">
                                                    <ul class="curriculum-sidebar-list">
                                                        @foreach ($section->lectures as $key => $lecture)
...
======================================-->
                    ...
                    <div class="modal-body">
                        <div class="copy-to-clipboard">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button
                                        class="btn theme-btn theme-btn-sm copy-btn shadow-none"><i
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-bottom-gray">
                        <div class="pr-2">
                            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24"
                                id="reportModalTitle">Report Abuse</h5>
                            <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Aduca staff
                    ...
                    <div class="modal-body">
                        <form method="post">
                                ...
                                <div class="form-group">
                                    <div class="select-container w-auto">
                                        <select class="select-container-select">
                                            ...
                                            <option value="1">Inappropriate Course Content
                                            </option>
                            ...
                            <div class="btn-box text-right pt-2">
                                ...
                                <button type="submit"
                                    class="btn theme-btn theme-btn-sm lh-30">Submit <i
                                        class="la la-arrow-right icon ml-1"></i></button>
                            </div>
                        </form>
                    </div><!-- end modal-body -->
        ...
        <!-- Modal -->
        <div class="modal fade modal-container" id="insertLinkModal" tabindex="-1"
            role="dialog" aria-labelledby="insertLinkModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-bottom-gray">
                        <div class="pr-2">
                            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24"
                                id="insertLinkModalTitle">Insert Link</h5>
                        </div>
                        <button type="button" class="close" data-dismiss="modal"
                            aria-label="Close">
                            <span aria-hidden="true" class="la la-times"></span>
                        ...
                        <form action="#">
                            ...
                            <div class="btn-box text-right pt-2">
                                <button type="button" class="btn font-weight-medium mr-3"
                                    data-dismiss="modal">Cancel</button>
                                <button type="submit"
                                    class="btn theme-btn theme-btn-sm lh-30">Insert <i
                                        class="la la-arrow-right icon ml-1"></i></button>
                            </div>
                        </form>
                    </div><!-- end modal-body -->
        ...
        <!-- Modal -->
        <div class="modal fade modal-container" id="uploadPhotoModal" tabindex="-1"
            role="dialog" aria-labelledby="uploadPhotoModalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-bottom-gray">
                        <div class="pr-2">
                            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24"
                                id="uploadPhotoModalTitle">Upload an Image</h5>
                        </div>
                        <button type="button" class="close" data-dismiss="modal"
                            aria-label="Close">
                            <span aria-hidden="true" class="la la-times"></span>
                    ...
                    <div class="modal-body">
                        <div class="file-upload-wrap">
                            ...
                            <span class="file-upload-text"><i class="la la-upload mr-2"></i>Drop
                                files here or click to upload</span>
