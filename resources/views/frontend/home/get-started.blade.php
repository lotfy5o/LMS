        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('asset-front')}}/images/img-loading.png"
                            data-src="{{asset('asset-front')}}/images/small-img-2.jpg" alt="card image"
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('asset-front')}}/images/img-loading.png"
                            data-src="{{asset('asset-front')}}/images/small-img-3.jpg" alt="card image"
                            class="img-fluid rounded-full lazy">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{asset('asset-front')}}/images/img-loading.png"
                            data-src="{{asset('asset-front')}}/images/small-img-4.jpg" alt="card image"
                            class="img-fluid rounded-full lazy">
