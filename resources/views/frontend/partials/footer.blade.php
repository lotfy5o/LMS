        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <a href="index.html">
                        <img src="{{asset('asset-front')}}/images/logo.png" alt="footer logo" class="footer__logo">
                    </a>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <div class="mobile-app">
                        ...
                        <a href="#" class="d-block mb-2 hover-s"><img src="{{asset('asset-front')}}/images/appstore.png"
                                alt="App store" class="img-fluid"></a>
                        <a href="#" class="d-block hover-s"><img src="{{asset('asset-front')}}/images/googleplay.png"
