                                                    ...
                                                    <div class="menu-banner position-relative h-100">
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="sign-up.html"
                                                                ...
                                                                Learning <i class="la la-arrow-right icon ml-1"></i></a>
                                                        </div>
                                                        <img src="{{asset('asset-front')}}/images/menu-banner-img.jpg"
                                                            alt="menu banner image" class="w-100 h-100 rounded-rounded">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
