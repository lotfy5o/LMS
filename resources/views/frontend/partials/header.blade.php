                    ...
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li
                                ...
                                <i class="la la-phone mr-1"></i><a href="tel:00123456789"> (00) 123
                                    456 789</a>
                            </li>
                            <li class="d-flex align-items-center"><i
                                    class="la la-envelope-o mr-1"></i><a
                    ...
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="index.html" class="logo"><img
                                    src="{{ asset('asset-front') }}/images/logo.png"
                                    alt="logo"></a>
                    ...
                    <div class="col-lg-10">
                        <div class="menu-wrapper">
                            <div class="menu-category">
                                <ul>
                                    <li>
                                        <a href="{{ route('frontend.allCategories') }}">Categories
                                            <i class="la la-angle-down fs-12"></i></a>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        @foreach ($category->subCategories as $subcategory)
                                                            <li><a
                                                                    href="{{ route('frontend.subcategoryDetails', ['category' => $category, 'subcategory' => $subcategory]) }}">{{ $subcategory->name }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px">
            ...
            <li>
                <a href="#">pages</a>
                <ul class="sub-menu">
                    <li><a href="dashboard.html">dashboard <span class="ribbon">Hot</span></a>
                    </li>
