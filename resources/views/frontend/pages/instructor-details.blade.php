            ...
            <div class="breadcrumb-content">
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full" src="{{ $instructor->getFirstMediaUrl('instructors') }}"
                            alt="Student thumbnail image">
                    </div>
                    <div class="media-body">
                        <h2 class="section__title fs-30">{{ $instructor->name }}</h2>
                        <span
                            class="d-block lh-18 pt-1 pb-2">{{ $instructor->created_at->diffForHumans() }}</span>
            ...
            <div class="student-details-wrap pb-20px">
                <div class="row">
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            <div class="counter__icon icon-element mb-3 shadow-sm">
                                <svg class="svg-icon-color-2" width="40" version="1.1"
                ...
                <div class="tab-content pt-40px" id="myTabContent">
                    <div class="tab-pane fade show active" id="about-me" role="tabpanel"
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                <p class="card-text pb-3">There are many variations of passages of Lorem
                                    Ipsum available, but the majority have suffered alteration in some
                                    form, by injected humour, or randomised words which don't look even
                                    slightly believable. Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Ab corporis est fugiat ipsa laboriosam laudantium
                                    possimus quo? Aperiam architecto laborum provident rerum, totam
                                    ullam! Accusantium eius eum perferendis quasi, repellendus suscipit
                                    voluptate voluptatem! Delectus dolorem maxime nulla numquam quasi
                                    quod.</p>
                                <p class="card-text pb-3">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Alias atque ipsa magnam, magni nobis quam ratione
                                    reiciendis totam? Accusantium aliquam aspernatur, assumenda
                                    cupiditate deleniti eius, ex fuga iusto minus, nihil perspiciatis
                                    porro provident quasi soluta ut! Consequuntur earum eos magnam?</p>
                                <div class="collapse" id="collapseReadMore">
                                    <p class="card-text pb-3">Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Alias consequatur consequuntur dolorem enim
                                        error est fuga iure magnam voluptas, voluptates.</p>
                                </div>
                                    ...
                                    <div class="skills">
                                        <div class="skill">
                                            <div
                                                ...
                                                <span
                                                    class="fs-16 text-black font-weight-semi-bold pr-3">HTML</span>
                                                <span>99%</span>
                                            </div>
                                        ...
                                        <div class="skill">
                                            <div
                                                class="d-flex flex-wrap align-items-center justify-content-between">
                                                <span
                                                    class="fs-16 text-black font-weight-semi-bold pr-3">CSS</span>
                                                <span>99%</span>
                                            </div>
                                            <div class="progress_bg">
                                                <div class="progress_bar"></div>
                        ...
                        <div class="card card-item card-preview"
                            ...
                            <div class="card-image">
                                <a href="course-details.html" class="d-block">
                                    <img class="card-img-top lazy"
                                        src="{{ $course->getFirstMediaUrl('courses_images') }}"
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><a
                                        href="{{ route('frontend.course.details', ['course' => $course]) }}">{{ $course->name }}</a>
                                </h5>
                                <p class="card-text"><a
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    @if ($course->discount_price == null)
                                        <p class="card-price text-black font-weight-bold">
                                            {{ number_format($course->selling_price, 2) }} </p>
                                    @else
                                        <p class="card-price text-black font-weight-bold">
                                            {{ number_format($course->discount_price, 2) }} <span
    ...
    @foreach ($instructor->courses as $course)
        <div class="tooltip_templates">
            <div id="tooltip_content_{{ $course->id }}">
                <div class="card card-item">
                    <div class="card-body">
                        <p class="card-text pb-2">By <a href="teacher-detail.html">
                        ...
                        <div class="d-flex align-items-center pb-1">
                            ...
                            <p class="text-success fs-14 font-weight-medium">Updated<span
                                    class="font-weight-bold pl-1">{{ $course->created_at->format('M d Y') }}</span>
                            </p>
                        </div>
                        <ul
                        ...
                        <ul class="generic-list-item fs-14 py-3">
                            @foreach ($course->goals as $goal)
                                <li><i class="la la-check mr-1 text-black"></i> {{ $goal->goal_name }}
                                </li>
                            @endforeach
