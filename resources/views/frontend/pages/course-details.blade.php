            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    ...
                    <div class="section-heading">
                        <h2 class="section__title">{{ $course->title }}
                        </h2>
                        <p class="section__desc pt-2 lh-30">{{ $course->name }}
                        </p>
                    </div><!-- end section-heading -->
                    <div class="d-flex flex-wrap align-items-center pt-3">
                        @if ($course->bestseller != null)
                    ...
                    <div class="course-details-content-wrap pt-90px">
                        ...
                        <div class="course-overview-card">
                            ...
                            <div class="collapse" id="collapseMore">
                                <p class="fs-15 pb-2">The core java material you need to learn java
                                    development is covered in the first seven sections (around 14 hours
                                    in total). The Java Basics are covered in those sections. The rest
                                    of the course covers intermediate, advanced, and optional material
                                    you do not technically need to go through.</p>
                                <h4 class="fs-20 font-weight-semi-bold py-2">Who this course is for:
                                </h4>
                                <ul class="generic-list-item generic-list-item-bullet fs-15">
                            ...
                            <div
                                ...
                                <div class="curriculum-duration fs-15">
                                    ...
                                    <span class="curriculum-total__hours"><strong
                                            class="text-black font-weight-semi-bold">Total
                                            hours:</strong> {{ $course->duration }} </span>
                                </div>
                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="heading{{ $section->id }}">
                                                <button
                                                    ...
                                                    {{ $section->name }}
                                                    <span
                                                        class="fs-15 text-gray font-weight-medium">{{ count($section->lectures) }}
                                                        lectures</span>
                                                </button>
                                            </div><!-- end card-header -->
                                                        ...
                                                        @foreach ($section->lectures as $lecture)
                                                            <li>
                                                                <a href="#"
                                                                    ...
                                                                    <span>
                                                                        <i
                                                                            class="la la-play-circle mr-1"></i>
                                                                        {{ $lecture->title }}
                                                                        <span
                                                                            class="ribbon ml-2 fs-13">Preview</span>
                                                                    </span>
                                ...
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        <a href="teacher-detail.html" class="media-img d-block">
                                            <img class="lazy"
                                                src="{{ $course->instructor->getFirstMediaUrl('instructors') ?: asset('upload/no-image.jpg') }}"
                                                data-src="{{ $course->instructor->getFirstMediaUrl('instructors') }}"
                                                alt="Avatar image">
                                        </a>
                                        <ul class="generic-list-item pt-3">
                                            <li><i class="la la-star mr-2 text-color-3"></i> 4.6
                                                Instructor Rating</li>
                                            <li><i class="la la-user mr-2 text-color-3"></i> 45,786
                                                Students</li>
                                            <li><i class="la la-comment-o mr-2 text-color-3"></i> 2,533
                                                Reviews</li>
                                    ...
                                    <div class="media-body">
                                        <h5><a href="teacher-detail.html">
                                                {{ $course->instructor->name }} </a></h5>
                                        <span class="d-block lh-18 pt-2 pb-3">Joined
                                            {{ Carbon\Carbon::parse($course->instructor->created_at)->diffForHumans() }}</span>
                                        ...
                                        <div class="collapse" id="collapseMoreTwo">
                                            <p class="pb-3">After learning the hard way, Tim was
                                                determined to become the best teacher he could, and to
                                                make his training as painless as possible, so that you,
                                                or anyone else with the desire to become a software
                                                developer, could become one.</p>
                                            <p class="pb-3">If you want to become a financial
                                                analyst, a finance manager, an FP&A analyst, an
                                                investment banker, a business executive, an
                                                entrepreneur, a business intelligence analyst, a data
                                                analyst, or a data scientist, <strong
                                                    class="text-black font-weight-semi-bold">Tim
                                                    Buchalka's courses are the perfect course to
                                                    start</strong>.</p>
                                        </div>
                                        <a class="collapse-btn collapse--btn fs-15"
                                            data-toggle="collapse" href="#collapseMoreTwo"
                                ...
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal"
                                        ...
                                        <img src="{{ $course->getFirstMediaUrl('courses_images') }}"
                                            data-src="{{ $course->getFirstMediaUrl('courses_images') }}"
                                        ...
                                        <div class="preview-course-video-content">
                                            ...
                                            <p class="fs-15 font-weight-bold text-white pt-3">Preview
                                                this course</p>
                                        </div>
                                    </a>
                                ...
                                <div class="preview-course-feature-content pt-40px">
                                    ...
                                    <div class="buy-course-btn-box">
                                        @if ($cart && $cart->courses->contains($course))
                                            <button type="button"
                                                class="cart-button btn btn-danger btn w-100 mb-2"
                                                onclick="removeFromCart('{{ $course->slug }}', this)">
                                                <i class="la la-shopping-cart mr-1 fs-18"></i>Remove
                                                From Cart
                                            </button>
                                        @else
                                            <button type="button"
                                                class="cart-button btn btn-success btn w-100 mb-2"
                                                onclick="addToCart('{{ $course->slug }}', this)">
                                                <i class="la la-shopping-cart mr-1 fs-18"></i>Add to
                                                Cart
                                            </button>
                                        @endif
                                        ...
                                        {{-- @if ($cart && $cart->courses->contains($course))
                                            <button type="button" class="btn theme-btn w-100 mb-2"><i
                                                    class="la la-shopping-cart fs-18 mr-1"
                                                    onclick="removeFromCart('{{ $course->slug }}', this)"></i>
                                                Remove From Cart</button>
                                        @else
                                            <button type="button" class="btn theme-btn w-100 mb-2"><i
                                                    class="la la-shopping-cart fs-18 mr-1"
                                                    onclick="addToCart('{{ $course->slug }}', this)"></i>
                                                Add To Cart</button>
                                        @endif --}}
                                    ...
                                    <div class="preview-course-incentives">
                                        ...
                                        <ul class="generic-list-item pb-3">
                                            <li><i
                                                    class="la la-play-circle-o mr-2 text-color"></i>{{ $course->duration }}
                                                hours on-demand video</li>
                                            <li><i
                                                    class="la la-file mr-2 text-color"></i>{{ $course->resources }}
                                                articles
                                            </li>
                                            <li><i class="la la-file-text mr-2 text-color"></i>12
                                                downloadable resources</li>
                                            <li><i class="la la-code mr-2 text-color"></i>51 coding
                                                exercises</li>
                                            <li><i class="la la-key mr-2 text-color"></i>Full lifetime
                                                access</li>
                                            <li><i class="la la-television mr-2 text-color"></i>Access
                                                on mobile and TV</li>
                                            <li><i
                                                    class="la la-certificate mr-2 text-color"></i>Certificate
                                                of Completion</li>
                                        </ul>
                                        <div class="section-block"></div>
                                        <div class="buy-for-team-container pt-4">
                                            <h3 class="fs-18 font-weight-semi-bold pb-2">Training 5 or
                                                more people?</h3>
                                            <p class="lh-24 pb-3">Get your team access to 3,000+ top
                                                Aduca courses anytime, anywhere.</p>
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-bolt mr-2 text-color"></i>Quizzes</span>
                                        26
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-eye mr-2 text-color"></i>Preview
                                            Lessons</span> 4
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i
                                                class="la la-language mr-2 text-color"></i>Language</span>
                                        English
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="la la-lightbulb mr-2 text-color"></i>Skill
                                            level</span> {{ $course->label }}
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i
                                                class="la la-users mr-2 text-color"></i>Students</span>
                                        30,506
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i
                            ...
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <a href="course-details.html" class="media-img">
                                        <img class="mr-3 lazy"
                                            src="{{ asset('asset-front') }}/images/img-loading.png"
                                            data-src="{{ asset('asset-front') }}/images/small-img-2.jpg"
                                            alt="Related course image">
                                    </a>
                                    <div class="media-body">
                                        <h5 class="fs-15"><a href="course-details.html">The Complete
                                                JavaScript Course 2021</a></h5>
                                        <span class="d-block lh-18 py-1 fs-14">Kamran Ahmed</span>
                                        <p class="text-black font-weight-semi-bold lh-18 fs-15">$12.99
                                ...
                                <div
                                    ...
                                    <a href="course-details.html" class="media-img">
                                        <img class="mr-3 lazy"
                                            src="{{ asset('asset-front') }}/images/img-loading.png"
                                            data-src="{{ asset('asset-front') }}/images/small-img-3.jpg"
                                            alt="Related course image">
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <span class="d-block lh-18 py-1 fs-14">Kamran Ahmed</span>
                                        <p class="text-black font-weight-semi-bold lh-18 fs-15">$129.99
                                        </p>
                                    </div>
                                </div><!-- end media -->
                                <div
                                    ...
                                    <a href="course-details.html" class="media-img">
                                        <img class="mr-3 lazy"
                                            src="{{ asset('asset-front') }}/images/img-loading.png"
                                            data-src="{{ asset('asset-front') }}/images/small-img-4.jpg"
                                            alt="Related course image">
                                    </a>
                                    <div class="media-body">
                                        <h5 class="fs-15"><a href="course-details.html">Introduction
                                ...
                                <div class="view-all-course-btn-box">
                                    <a href="course-grid.html" class="btn theme-btn w-100">View All
                                        Courses <i class="la la-arrow-right icon ml-1"></i></a>
                                </div>
                            </div>
                        </div><!-- end card -->
                        <div class="card card-item">
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                ...
                                <div class="course-badge-labels">
                                    @if ($relatedCourse->bestseller)
                                        <div class="course-badge">Bestseller</div>
                                    @endif
                                    <div class="course-badge blue">
                                        -{{ $relatedCourse->discountPercentage }}%</div>
                                </div>
                            </div><!-- end card-image -->
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    @if ($relatedCourse->discount_price == null)
                                        <p class="card-price text-black font-weight-bold">
                                            {{ number_format($course->selling_price) }} </p>
                                    @else
                                        <p class="card-price text-black font-weight-bold">
                                            {{ number_format($relatedCourse->discount_price, 2) }}
                                            <span
                                                class="before-price font-weight-medium">{{ number_format($course->selling_price, 2) }}</span>
                                        </p>
                                    @endif
                                    <div class="icon-element icon-element-sm shadow-sm"
                                        title="In Wishlist">
                                        <i
                                            class="la {{ $relatedCourse->isWishlistedByCurrentUser() ? 'la-heart' : 'la-heart-o' }} mr-1"></i>
                                    </div>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <div class="cta-content-wrap py-4 d-flex flex-wrap align-items-center">
                        ...
                        <div class="section-heading">
                            <h2 class="section__title mb-1 fs-22">Become a Teacher, Share your
                                knowledge</h2>
                            <p class="section__desc">Create an online video course, reach students
                                across the globe, and earn money</p>
                        </div><!-- end section-heading -->
                    </div>
                </div><!-- end col-lg-9 -->
                <div class="col-lg-3">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <h5 class="modal-title fs-19 font-weight-semi-bold" id="shareModalTitle">Share
                        this course</h5>
                ...
                <div class="modal-footer justify-content-center border-top-gray">
                    <ul class="social-icons social-icons-styled">
                        <li><a href="#" class="facebook-bg"><i class="la la-facebook"></i></a>
                        </li>
                        <li><a href="#" class="twitter-bg"><i class="la la-twitter"></i></a>
                        </li>
            ...
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <div class="pr-2">
                        ...
                        <h5 class="modal-title fs-19 font-weight-semi-bold lh-24"
                            id="previewModalTitle">{{ $course->name }}
                        </h5>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="la la-times"></span>
                ...
                <div class="modal-body">
                    <video controls crossorigin playsinline
                        poster="{{ $course->getFirstMediaUrl('courses_images') }}" id="player">
                        <!-- Video files -->
            ...
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <div class="pr-2">
                        ...
                        <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Aduca staff to
                            determine whether it violates Terms of Service or Community Guidelines. If
                            you have a question or technical issue, please contact our
                            <a href="contact.html" class="text-color hover-underline">Support team
                                here</a>.
                        </p>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
