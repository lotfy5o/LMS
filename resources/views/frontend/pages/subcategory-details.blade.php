            ...
            <div class="filter-bar mb-4">
                <div
                    ...
                    <p class="fs-14">We found <span
                            class="text-black">{{ $subcategory->courses->count() }}</span> courses
                        available for
                        you in {{ $subcategory->name }}</p>
                    {{-- <div class="d-flex flex-wrap align-items-center">
                        <ul class="filter-nav mr-3">
                            <li><a href="course-grid.html" data-toggle="tooltip" data-placement="top"
                                    title="Grid View" class="active"><span
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($allCategories as $category)
                                    <div class="custom-control custom-checkbox mb-1 fs-15">
                                        ...
                                        <label
                                            class="custom-control-label custom--control-label text-black"
                                            for="catCheckbox">
                                            {{ $category->name }}<span
                                                class="ml-1 text-gray">({{ $category->courses->count() }})</span>
                                        </label>
