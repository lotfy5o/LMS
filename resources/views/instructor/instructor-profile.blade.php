                                ...
                                <form action="{{ route('instructor.profile.store') }}" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <img id="showImage"
                                                    src="{{ (!empty($profileData->photo)) ? url('upload/instructor-images/' . $profileData->photo) : url('upload/no-image.jpg') }}"
                                                    alt="Instructor" class="rounded-circle p-1 bg-primary" width="100">
                                            </div>
                                        </div>
                                        <div class="row">
