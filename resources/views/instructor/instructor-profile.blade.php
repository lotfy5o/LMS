                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">User Profilep
                                </li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="container">
                    <div class="main-body">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img id="showImage"
                                                src="{{ $profileData->getFirstMediaUrl('instructors') ?: asset('upload/no-image.jpg') }}"
                                                alt="Instructor" class="rounded-circle p-1 bg-primary"
                                                width="110">
                                            <div class="mt-3">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                ...
                                                <span
                                                    class="text-secondary">https://codervent.com</span>
                                            </li>
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                                <h6 class="mb-0"><svg
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <form action="{{ route('instructor.profile.store') }}"
