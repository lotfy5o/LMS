                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Iphone 5</td>
                                    <td><img src="{{ asset('asset-back') }}/images/products/01.png"
                                ...
                                <tr>
                                    <td>Earphone GL</td>
                                    <td><img src="{{ asset('asset-back') }}/images/products/02.png"
                                            class="product-img-2" alt="product img"></td>
                                    <td>#8304620</td>
                                    <td><span
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ asset('asset-back') }}/images/products/03.png"
                                            class="product-img-2" alt="product img"></td>
                                    <td>#4736890</td>
                                    <td><span
                                ...
                                <tr>
                                    <td>Clasic Shoes</td>
                                    <td><img src="{{ asset('asset-back') }}/images/products/04.png"
                                            class="product-img-2" alt="product img"></td>
                                    <td>#8543765</td>
                                    <td><span
                                            class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span>
                                ...
                                <tr>
                                    <td>Sitting Chair</td>
                                    <td><img src="{{ asset('asset-back') }}/images/products/06.png"
                                            class="product-img-2" alt="product img"></td>
                                    <td>#9629240</td>
                                    <td><span
                                            class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span>
                                ...
                                <tr>
                                    <td>Hand Watch</td>
                                    <td><img src="{{ asset('asset-back') }}/images/products/05.png"
                                            class="product-img-2" alt="product img"></td>
                                    <td>#8506790</td>
                                    <td><span
                                            class="badge bg-gradient-bloody text-white shadow-sm w-100">Failed</span>
